...
export const StyledEndChatConfirmation = styled.div`
  width: 360px;
  height: 280px;
  ...
  padding-bottom: 16px;
`;
export const StyledEndChatConfirmationIcon = styled.div`
  width: 41px;
  height: 41px;
  margin: auto;
  & > div {
...
`;
export const StyledEndChatInformationConfirmation = styled.div`
  align-items: center;
  width: 318px;
  height: fit-content;
  margin: auto;
...
export const StyledFooterEndChatConfirmation = styled.div`
  width: 360px;
  height: 55px;
  display: flex;
